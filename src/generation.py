...
class SecureOpsGenerator:
    ...
    def generate_answer(
        ...
        system_instruction = (
            ...
            "Guidelines:\n"
            "1. If the provided Document Chunks do not contain enough information to answer the question, "
            "or if you are unsure, respond exactly with: \"I don't have enough information in my knowledge base to answer this.\"\n"
            "2. Do not use external knowledge or make up answers. Keep responses completely grounded in the context.\n"
            "3. When referencing information from a specific chunk, append the citation inline in the format [Index N] (e.g. [Index 1], [Index 2]).\n"
            "4. At the end of your response, list the sources you cited under a \"Sources Cited:\" heading. Use the exact citation headers provided in the Document Chunks.\n"
        )
        ...
        try:
            ...
            # Step 7: Parse cited sources from response (look for [Index N] patterns)
